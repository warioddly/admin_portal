...
import RightSidebarComponent from "@/components/dashboard/RightSidebarComponent";
...
export default {
  ...
  methods: {
    ...
    condenseSidebar() {
      document.getElementsByTagName('body')[0].setAttribute('data-leftbar-compact-mode', "");
    }
